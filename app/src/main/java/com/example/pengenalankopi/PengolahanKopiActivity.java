...
public class PengolahanKopiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengolahan_kopi);

        back_to_menu = findViewById(R.id.back_to_kopi);
        back_to_menu.setOnClickListener(this);
    }

//    untuk tau siapa parent activity nya
    private void linkKeActivity(){
        ...
        try {
            ...
            Intent i = new Intent(PengolahanKopiActivity.this, fromClass);
